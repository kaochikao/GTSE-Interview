...
"""
理解：
- 這邊先去找0 (or 正數的起點)，所以之後少很多判斷，
- 演算法本身很簡單，實現上有很多細節
- 雖然實現上很多步驟，但因為很多都是simple for loop, 所以不會增加時間複雜度

實現技巧：
- 另外declare 一個merge function, 所以思考起來不會那麼複雜
- list comprehension也可以用
- Python list extend (好用)
